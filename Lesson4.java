/*
 * Created by David Karchikyan on 24.02.2022
 */
...
public class Lesson4 {
    ...
    private static boolean checkWin(char dot) {
        ...
        for (int i = 0; i < map.length; i++) {
            if (map[i][i] == dot || map[i][map.length - 1 - i] == dot) {
                count++;
            } else {
                break;
            }
    ...
    private static void print() { //Отрисовываем номера
    ...
    private static void init() { //Отрисовываем поле, ставим точки
